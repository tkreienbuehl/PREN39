...
Das Softwarekonzept basiert auf dem Model-View-Control Prinzip, wobei sich die View auf einen Debug-Zweck beschränkt. Dabei hat der Controller alle Subprozesse sowie die Schnittstelle zur Harwaresteuerung, via Microcontroller-Board realisiert, unter Kontrolle. Die Subprozesse sind:
\begin{itemize}
\item Bilderzeugung
