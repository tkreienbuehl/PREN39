...
Da die Servomotoren für die Lenkung und den Greiferarm noch nicht definitiv feststehen, werden für die Kapazitätenberechnung Motoren genommen die den Anforderungen am nächsten kommen.\\
Leistungsberechnung für den Motor Lenkung:
\begin{itemize}
\[
P=2\cdot \pi\cdot N\cdot M \to 2\cdot \pi\cdot 0.92\frac{U}{sec}\cdot 0.65Nm = 3.76W
\]
\end{itemize}
Leistungsberechnung für den Motor Greiferarm:
\begin{itemize}
\[
...
0.5Ah
\]
Da im Laufe des Projektes noch Änderungen auftreten können, dienen die berechneten Kapazitäten vorerst als Richtwerte.
\end{itemize}
