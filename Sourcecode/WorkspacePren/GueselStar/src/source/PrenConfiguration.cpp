...
PrenConfiguration::PrenConfiguration() {
		...
		SLOPE_VAL_FOR_BEND_RIGHT = parser.readFloatParam("SLOPE_VAL_FOR_BEND_RIGHT");
		SLOPE_VAL_FOR_BEND_LEFT = parser.readFloatParam("SLOPE_VAL_FOR_BEND_LEFT");
		SLOPE_UPPER_VAL_FOR_STRAIGHT = parser.readFloatParam("SLOPE_UPPER_VAL_FOR_STRAIGHT");
		SLOPE_LOWER_VAL_FOR_STRAIGHT = parser.readFloatParam("SLOPE_LOWER_VAL_FOR_STRAIGHT");
}
